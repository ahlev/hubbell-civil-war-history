...
window.CinematicPlayer = (function () {
  ...
  const WAYPOINTS = [
    ...
    },
    {
      ...
      body: 'October 1863. Alexander\'s XI Corps boards trains for Tennessee — a thousand miles of railroad, the longest troop movement of the war. The map zooms out. This war is no longer a Virginia affair. Alexander leaves the fields where Henry died and heads into an entirely different theater. The scale of the conflict becomes staggering.',
      quote: null,
      quoteCite: null,
      letterId: 'LTR-1863-09-29-001',
      brothers: ['alexander'],
