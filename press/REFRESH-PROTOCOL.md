...
- [ ] **Retired angles stay retired**: the asymmetry-of-register finding is OFF press surfaces (user call 2026-07-08); it may appear only as the creator's personal impression (FAQ framing), never as a data claim or first-publication card. Sweep pitches for any survival of the ONE first-publication card noted in `project_outreach_v2`.
