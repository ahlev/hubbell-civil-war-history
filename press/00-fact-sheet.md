# Fact Sheet — The Hubbell Civil War Letters

*One-page reference for journalists. Everything here is drawn from the project's own data and documentation.*
...
**The five-generation stewardship:** Frances saved the letters → Gladys Sands Hubbell typed them (1947–49) → Fred Alexander Hubbell Jr. introduced them (1996) → Bruce Levitt digitized them (2010s) → Alexander Hubbell Levitt structured and published them (2026).

**Where to see it:** [DASHBOARD URL — creator to confirm public link before any pitch is sent]

**Contact:** Alexander Hubbell Levitt · theaihubops@gmail.com

**Methodology, in writing:** two companion essays and a methodology paper document how the corpus was built and verified (links in `MEDIA-KIT.md`).
