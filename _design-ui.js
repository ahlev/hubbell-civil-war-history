      ...
      '<nav class="site-nav" aria-label="Primary">' +
        '<div class="site-nav-inner">' +
          ...
          '<div class="search-wrap" id="navSearch">' +
            ...
            '</svg>' +
            '<input type="text" class="search-input-nav" id="searchInput" placeholder="Search 272 letters\u2026" autocomplete="off" aria-label="Search the letter collection">' +
        ...
        '<div class="mobile-drawer" id="mobileDrawer">' +
          '<div class="mobile-drawer-search">' +
            '<svg class="search-icon-nav" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round">' +
              '<circle cx="11" cy="11" r="7"/><path d="M21 21l-4.35-4.35"/>' +
            '</svg>' +
            '<input type="text" class="search-input-nav" id="searchInputMobile" placeholder="Search 272 letters\u2026" autocomplete="off" aria-label="Search the letter collection">' +
