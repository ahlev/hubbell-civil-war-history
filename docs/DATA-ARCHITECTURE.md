...
**Hubbell Civil War Letter Collection — 272 Letters, 1861–1870**
...
- **Algorithmic** — they apply consistent rules across all 272 letters
...
These eleven boolean flags and their `flagDetails` companions are fully populated across all 272 letters but currently invisible to users:
